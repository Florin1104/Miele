...
public:
  ...
  /*******************************************************************************
    ...
    *******************************************************************************/
  bool DisplayFormatedString_b(char* StringToDisplay_pc,uint8_t R,uint8_t G,uint8_t B, 
  uint8_t direction,uint8_t indent_x,uint8_t indent_y,const ucg_fntpgm_uint8_t *font );
    ...
    @Parameters     XXXXXXXXX
    *******************************************************************************/
  bool SendCharacter_b(char CharacterToDisplay);
};
